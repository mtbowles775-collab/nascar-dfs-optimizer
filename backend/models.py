...
from sqlalchemy import (
    Column, Integer, String, Decimal, Boolean, Date,
...
class Track(Base):
    ...
    length_miles    = Column(Decimal(5, 3), nullable=False)
...
class Race(Base):
    ...
    total_miles     = Column(Decimal(7, 2))
    status          = Column(String(20), default="scheduled")
    notes           = Column(Text)
    created_at      = Column(DateTime, server_default=func.now())
    __table_args__  = (UniqueConstraint("season", "race_number"),)
...
class Qualifying(Base):
    ...
    lap_time_sec    = Column(Decimal(8, 4))
    lap_speed_mph   = Column(Decimal(7, 3))
...
class Practice(Base):
    ...
    best_lap_time   = Column(Decimal(8, 4))
    best_lap_speed  = Column(Decimal(7, 3))
    avg_lap_speed   = Column(Decimal(7, 3))
...
class Result(Base):
    ...
    fastest_lap_time    = Column(Decimal(8, 4))
    fastest_lap_speed   = Column(Decimal(7, 3))
    green_flag_laps     = Column(Integer)
    green_flag_speed    = Column(Decimal(7, 3))
    dk_salary           = Column(Integer)
    dk_points           = Column(Decimal(6, 2))
    dk_place_pts        = Column(Decimal(6, 2))
    dk_place_diff_pts   = Column(Decimal(6, 2))
    dk_laps_led_pts     = Column(Decimal(6, 2))
    dk_fast_lap_pts     = Column(Decimal(6, 2))
    dk_laps_complete_pts= Column(Decimal(6, 2))
    dk_dominator_bonus  = Column(Decimal(6, 2))
    fd_salary           = Column(Integer)
    fd_points           = Column(Decimal(6, 2))
    fd_place_pts        = Column(Decimal(6, 2))
    fd_laps_led_pts     = Column(Decimal(6, 2))
    fd_fast_lap_pts     = Column(Decimal(6, 2))
    fd_place_diff_pts   = Column(Decimal(6, 2))
    created_at          = Column(DateTime, server_default=func.now())
    __table_args__      = (UniqueConstraint("race_id", "driver_id"),)
...
class LoopData(Base):
    ...
    pct_laps_in_top15       = Column(Decimal(5, 2))
    fastest_lap_pct         = Column(Decimal(5, 2))
    avg_running_position    = Column(Decimal(5, 2))
    driver_rating           = Column(Decimal(6, 2))
...
class Ownership(Base):
    ...
    ownership_pct   = Column(Decimal(5, 2))
    captain_pct     = Column(Decimal(5, 2))
...
class SimulationDriverResult(Base):
    ...
    driver_id       = Column(Integer, ForeignKey("drivers.id"), nullable=False)
    avg_fp          = Column(Decimal(6, 2))
    median_fp       = Column(Decimal(6, 2))
    floor_fp        = Column(Decimal(6, 2))
    ceiling_fp      = Column(Decimal(6, 2))
    avg_finish      = Column(Decimal(5, 2))
    avg_laps_led    = Column(Decimal(6, 2))
    fast_lap_pct    = Column(Decimal(5, 3))
    win_pct         = Column(Decimal(5, 3))
    top3_pct        = Column(Decimal(5, 3))
    top5_pct        = Column(Decimal(5, 3))
    top10_pct       = Column(Decimal(5, 3))
    proj_ownership  = Column(Decimal(5, 2))
    leverage_score  = Column(Decimal(5, 2))
...
class Lineup(Base):
    ...
    proj_fp         = Column(Decimal(6, 2))
    proj_ceiling    = Column(Decimal(6, 2))
    created_at      = Column(DateTime, server_default=func.now())
